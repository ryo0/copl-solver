...
//  file1.write(solve("let x = let y = 3 - 2 in y * y in let y = 4 in x + y"))
  val file1 = new PrintWriter("EvalML3Result/1.txt")
  file1.write(solve("fun x -> x + 1"))
  file1.close()

  val file2 = new PrintWriter("EvalML3Result/2.txt")
  file2.write(solve("let y = 2 in fun x -> x + y"))
  file2.close()

  val file3 = new PrintWriter("EvalML3Result/3.txt")
  file3.write(solve("let sq = fun x -> x * x in sq 3 + sq 4"))
  file3.close()

  val file4 = new PrintWriter("EvalML3Result/4.txt")
  file4.write(solve("let sm = fun f -> f 3 + f 4 in sm (fun x -> x * x))"))
  file4.close()

  val file5 = new PrintWriter("EvalML3Result/5.txt")
  file5.write(
    solve("let max = fun x -> fun y -> if x < y then y else x in max 3 5")
  )
  file5.close()

  val file6 = new PrintWriter("EvalML3Result/6.txt")
  file6.write(solve("let a = 3 in let f = fun y -> y * a in let a = 5 in f 4"))
  file6.close()

  val file7 = new PrintWriter("EvalML3Result/7.txt")
  file7.write(
    solve("let twice = fun f -> fun x -> f (f x) in twice (fun x -> x * x) 2")
  )
  file7.close()

  val file8 = new PrintWriter("EvalML3Result/8.txt")
  file8.write(
    solve(
  ...
  val file9 = new PrintWriter("EvalML3Result/9.txt")
  file9.write(
    solve(
  ...
  val file10 = new PrintWriter("EvalML3Result/10.txt")
  file10.write(
    solve(
  ...
  val file12 = new PrintWriter("EvalML3Result/12.txt")
  file12.write(
    solve(
  ...
  val file13 = new PrintWriter("EvalML3Result/13.txt")
  file13.write(
    solve(
  ...
  val file14 = new PrintWriter("EvalML3Result/14.txt")
  file14.write(
    solve(
  ...
  val file42 = new PrintWriter("EvalML4Result/1.txt")
  file42.write(
    solve(
